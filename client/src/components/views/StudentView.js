...
import { Container, Typography, Card, Button, Grid, Select, FormControl, InputLabel, MenuItem} from '@material-ui/core/'
    ...
    <>  
      ...
      <Typography variant='h2' align='center'>Student Page</Typography>
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}>
            ...
            <Typography variant='subtitle1' align='left'>{"GPA: " + student.gpa}</Typography>
      ...
      {student.campus === null ? (
        ...
        <Typography variant='subtitle1' align='left'>This student is registered to a campus</Typography>
          <Card>
          <Typography align='center'><img src={student.campus.imageURL} alt="campus"></img></Typography>
